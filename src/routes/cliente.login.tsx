...
export const Route = createFileRoute("/cliente/login")({
  head: () => ({
    meta: [
      { title: "Acceso cliente — Hispajuris" },
    ...
    <div className="flex min-h-screen items-center justify-center bg-gradient-hero px-4 py-12">
      <div className="w-full max-w-md">
        ...
        <div className="rounded-2xl border border-border bg-card p-8 shadow-elegant">
          <h1 className="text-2xl font-bold text-primary">Mi caso</h1>
          <p className="mt-1.5 text-sm text-muted-foreground">
            Accede a tu área personal para gestionar tu reclamación.
          </p>
        ...
        <Link
          to="/"
          className="mt-6 block text-center text-xs text-primary-foreground/70 hover:text-accent"
        >
          ← Volver a la web
        </Link>
      </div>
